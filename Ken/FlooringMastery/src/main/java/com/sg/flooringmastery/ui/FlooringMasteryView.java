...
//******************************************************************************    
    ...
    public String displayCustomerNameBanner(String existingCustomerName) 
    ...
    public String displayStateTaxBanner(StateTax existingStateTax) 
            throws InvalidInputException {
    ...
    public String displayProductNameBanner(Product existingProduct) 
            throws InvalidInputException {
...
//******************************************************************************
    ...
    public Order editOrderAttributesChange(LocalDate date, Order order)
                    ...
                    case 4:
                        ...
                        if (newProductType.equals("")) {
                            ...
                            try {
                                ...
                                throw new InvalidInputException(" Product Name Not Found");
                            }
                        }
                        break;
                    case 5:
                        ...
                        if (newArea.compareTo(BigDecimal.ZERO) > 0) {
                            ...
                            throw new InvalidInputException(" Area Can Not Found");
                        }
                    case 6:
                        writeAgain = false;
                        break;
