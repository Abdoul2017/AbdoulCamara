...
//                inputReader.nextLine();
    ...
    public BigDecimal readBigDecimal(String prompt)
        ...
        try {
            ...
            throw new InvalidInputException("INPUT ERROR. YOU ENTERED AN INVALID INPUT");
        }
    }
        ...
        do {
            try {
                ...
                if (userInput.equalsIgnoreCase("Carpet") || userInput.equalsIgnoreCase("Laminate")
                    ...
                    badInput = false;
                    //                    if(userInput.equalsIgnoreCase("Carpet")){
//                        userInput="Carpet";
//                    }
//                    if(userInput.equalsIgnoreCase("Laminate")){
//                        userInput="Laminate";
//                    }
//                    if(userInput.equalsIgnoreCase("Tile")){
//                        userInput="Tile";
//                    }
//                    if(userInput.equalsIgnoreCase("Wood")){
//                        userInput="Wood";
//                    }

                } else {
                    badInput = true;
                    System.out.println("================Please Enter Either:Carpet, Laminate, Tile or Wood===========");
                }
