...
public class StateTax {
    ...
    FlooringMasteryStateTaxDaoFileImpl taxdao = new FlooringMasteryStateTaxDaoFileImpl();
//******************************************************************************
...
//******************************************************************************
    public BigDecimal getTaxRate(String newStateName) 
            throws FlooringMasteryPersistenceException{
        return taxdao.getTax(newStateName).getTaxRate();
    }
//******************************************************************************    
