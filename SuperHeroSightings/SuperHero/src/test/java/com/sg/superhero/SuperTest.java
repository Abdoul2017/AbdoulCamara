...
//**************************SUPER PERSON TESTS BEGIN****************************
    ...
    @Test
    public void TestGetAllSuperPersonsListSize() {
        System.out.println("TEST GET ALL SUPER PERSONS");
        //Arrange
        SuperPerson superPerson = new SuperPerson();
        superPerson.setName("Jeff Hiller");
    ...
    public void TestGetAllPersonsByOrganizationId() {
        ...
        List<SuperPerson> testPersonList = superDao.getSuperPersonByOrganization(699);
    ...
    public void TestGetAllPersonsByLocationId() {
        ...
        List<SuperPerson> testPersonList = superDao.getSuperPersonByLocation(333);
